...
<body>
	...
	<jsp:include page="/WEB-INF/subviews/picture/small_menu.jsp">
		<jsp:param name="theSubtitle" value="<a class=\" small_menu_a\" href=\"/gtt\">首頁</a>>新進產品   " />
                        <jsp:param name="h2_theSubtitle" value="新進產品" /></jsp:include>
	...
	<div style="background-color: white;">
		...
		<ul id="product_list">
			...
			<li style="height: 350px; box-shadow: none;">
				<div style="position: absolute; z-index: 1; right: 0; background-color: #6699ff; color: white; opacity: 0.7; width: 50px; height: 30px; line-height: 30px;">NEW</div> <a href="product.jsp?productId=<%=list.get(i).getId()%>" class="hover"><img src="<%=list.get(i).getPhotoUrl()%>"><img src="<%=list.get(i).getPhotoUrl2()%>"></a>
