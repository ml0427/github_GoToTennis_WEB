...
<body>
	...
	<div class="article">
		<div class="article_2">
			...
			<form action='check_out.do' method="POST" style="padding: 20px 0;">
				<table style='width: 100%; margin: 0 auto;'>
					...
					<tfoot>
						...
						<tr>
							<td colspan="2">購買了</td>
							<td colspan="3" style='background-color: #eee; width: 300px;'><%=cart.getTotalQuantity()%>項商品
							</td>
						</tr>
						<tr>
							<td colspan="5">
						...
						<tr>
							<td colspan="2">小計</td>
							<td colspan="3" style='background-color: #eee; width: 300px;'><%=Math.round(cart.getTotalAmount())%>元
							</td>
						</tr>
						<tr>
							<td colspan="5">
						...
						<tr>
							<td colspan="2">總金額</td>
							<td colspan="3" style='background-color: #eee;'>
								<span id="allfeeSpan"><%=Math.round(cart.getTotalDiscountedAmount())%></span>
								元
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td colspan="5">
								<div class="user_data" style="text-align: left;">
									...
									<label>姓名:</label>
									<input readonly value="<%=member.getName()%>" id="name">
									<br>
									<label>電郵:</label>
									<input readonly value="<%=member.getEmail()%>" id="email">
									<br>
									<label>電話:</label>
									<input readonly value="${sessionScope.member.phone}" id="phone">
									<br>
									<label>地址:</label>
									<input readonly value="${sessionScope.member.address}" id="addr">
									<br>
								</div>
								<div class="user_data" style="text-align: left; position: relative">
									<legend class="big_label">
										收件人
										<a style="position: absolute; right: 0;" href="javascript:copy()">同訂購人</a>
									</legend>
									<label>姓名:</label>
									<input required value="" name="recipientName" id="recipientName">
									<br>
									<label>電郵:</label>
									<input required value="" name="recipientEmail" id="recipientEmail">
									<br>
									<label>電話:</label>
									<input required value="" name="recipientPhone" id="recipientPhone">
									<br>
									<label>地址:</label>
									<input required value="" name="recipientAddr" id="recipientAddr">
									<br>
								</div>
								<script>
									function copy() {
						...
						<tr>
							<td colspan="1">
								<input class="again_input" type='button' value='繼續購物' onclick='goshopping()'>
							</td>
							<td colspan="3"></td>
							<td colspan="1">
								<input class="sub_data" type="submit" value="送出訂單">
							</td>
						</tr>
					</tfoot>
				</table>
			...
			<p>
				購物車是空的! 請
				<a href="<%=request.getContextPath()%>/products_list.jsp">回賣場購物</a>
				後才執行結帳功能
			</p>
			<%
				}
