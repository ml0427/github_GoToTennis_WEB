...
<body>
    ...
    <jsp:param name="h2_theSubtitle" value="觀看紀錄" /></jsp:include>
		...
		<div class="article_2">
			...
			<div style="float: left; width: 100%;">
				<div class="discriptionimg">
					<a
						href="<%=request.getContextPath()%>/product.jsp?productId=<%=list.get(i).getProduct().getId()%>">
						<img style="width: 20%; float: left;"
						src="<%=list.get(i).getProduct().getPhotoUrl()%>">
					</a>
					<div class="label"><%=list.get(i).getProduct().getName()%></div>
					<br>
					<div>
					...
					<div style="position: absolute; right: 100px; top: 220px;">
						遊覽時間：<%=list.get(i).getViewtime()%></div>
					<a
						href="<%=request.getContextPath()%>/product.jsp?productId=<%=list.get(i).getProduct().getId()%>">
