		...
		<div class="article">
			...
			<form action="login.do" method="POST">
				...
				<p>
					...
					<input id="email" name="email" value="<%=request.getParameter("email") == null ? email : request.getParameter("email")%>" placeholder="請輸入Email" required>
					<br>
					<input style="height: auto; width: auto;" type="checkbox" name="remember">
					<samp>記住我的帳號</samp>
				...
				<p>
					<label for="captcha">
						...
						<a href="javascript:refreshCaptcha()" title="點選圖片即可更新">
							<img id="captcha_image" src="/gtt/images/captcha.jpg" style="vertical-align: middle">
						</a>
						<br>
					</label>
					<input type="text" id="captcha" value="<%=request.getParameter("captcha") == null ? "" : request.getParameter("captcha")%>" name="captcha" placeholder="請輸入驗證碼(不分大小寫)" required>
					<br>
				</p>
				<p>
					<input id="login_input" type="submit" value="登入">
					<input id="new_user_input" type="button" value="註冊新帳號" onclick="location.href = '/gtt/register.jsp'">
