...
<div class="up_page" style="">
        ...
        <%for (int i = 1; i <= (list.size() % content_number == 0 ? (list.size() / content_number) : (list.size() / content_number) + 1); i++) {
                                         if (i == user_page) {%>
        <a style="background-color: #9999ff; " href="?name=<%=request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=<%=i%>&content_number=<%=content_number%>"><%=i%></a> <!--現在頁面背景改成藍色-->
        <%} else {%>
        ...
        <div  id="xx"><a style="background-color: #9999ff;" href="?name=<%= request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=1&content_number=10">10</a></div>
        <%} else {%>
        <div id="xx"><a href="?name=<%= request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=1&content_number=10">10</a></div>
        <%}%>

        <% if (content_number == 20) {%>       
        <div id="yy"><a style="background-color: #9999ff;" href="?name=<%= request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=1&content_number=20">20</a></div>
        <%} else {%>
        <div id="yy"><a href="?name=<%= request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=1&content_number=20">20</a></div>
        <%}%>
        
        <% if (content_number == 30) {%>       
        <div id="zz"><a style="background-color: #9999ff;"  href="?name=<%= request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=1&content_number=30">30</a></div>
        <%} else {%>
        <div id="zz"><a href="?name=<%= request.getParameter("name") == null ? "" : request.getParameter("name")%>&category=<%=request.getParameter("category") == null ? "" : request.getParameter("category")%>&ppp=1&content_number=30">30</a></div>
        <%}%>
