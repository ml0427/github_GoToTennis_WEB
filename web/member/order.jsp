...
<html>
        <head>
                ...
                <script>
                        function goorder() {
                                location.href = "<%= request.getContextPath()%>/member/orders_history.jsp";
                        }
                </script>
                ...
                <div class="article">       
                        <div class="article_2">
                                ...
                                <div style="text-align: left;">
                                        <br>
                                        訂單編號：<%= order.getOrderTime().getYear()%><%= order.getOrderTime().getMonthValue()%>-<%= String.format("%03d", order.getId())%>
                                        <hr>
                                        ...
                                        <div>姓名:<%= order.getRecipientName()%><hr></div>
                                        <div>電郵:<%= order.getRecipientEmail()%><hr></div>
                                        <div>電話:<%= order.getRecipientPhone()%><hr></div>
                                        <div>地址:<%= order.getRecipientAddr()%><hr></div>
                                </div>
                                ...
                                <div>
                                        ...
                                        <table style='width:90%;margin:  auto;'>
                                                ...
                                                <tbody> 
                                                        ...
                                                        <tr ><td colspan="5"><hr style="margin: 0;"></td></tr>
                                                        <tr ><td colspan="5"><div><br></div></td></tr>
                                                        <tr >
